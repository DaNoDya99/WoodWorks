...
<div class="main">
    ...
    <div class="grid-item mainbg ">
        <div>
            <div style="display: grid; justify-content:center ;width: 30vw;background-color: white; padding: 40px; border-radius: 10px; box-shadow: 0px 5px 10px rgba(107, 107, 107, 0.753);">
                <h1>Login</h1>
