...
class Order_Items extends Model
{
    ...
    {
        $query = "SELECT order_item.ProductID, order_item.OrderID, order_item.Name, order_item.Quantity, order_item.Cost, order_item.Image,order_item.Date, furniture.Wood_type,furniture.Warrenty_period FROM order_item INNER JOIN furniture ON order_item.ProductID = furniture.ProductID WHERE order_item.OrderID = :OrderID; ";
